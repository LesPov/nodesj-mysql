...
const getUserProfile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _c, _d;
    const { userId } = req.params;
    const loggedInUserId = (_c = req.user) === null || _c === void 0 ? void 0 : _c.userId; // Obtener el userId del usuario que inició sesión
    try {
        // Buscar al usuario por su userId junto con la información del perfil
        const user = yield authModel_1.Auth.findOne({
            where: { id: userId },
        ...
        if (((_d = req.user) === null || _d === void 0 ? void 0 : _d.rol) === 'admin' || Number(userId) === loggedInUserId) {
